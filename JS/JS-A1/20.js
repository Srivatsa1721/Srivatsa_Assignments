...
<body>
    <Form class="form" id="newform">
        ...
        <label for="t2">Pepperoni</label>
        <input type="checkbox" id="t2" name="pl" value="Pepperoni">
        ...
        <label for="t7">Mushrooms</label>
        <input type="checkbox" id="t7"  name="pl" value="Mushrooms">

        <h3>How do you want to get your pizza?</h3>
        <label for="s1">Delivery</label>
        <input type="radio" id="s1" name="transport" value="Delivery">
